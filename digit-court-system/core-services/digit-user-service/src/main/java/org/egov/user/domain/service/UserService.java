...
public class UserService {
    ...
    public UserService(UserRepository userRepository, OtpRepository otpRepository, FileStoreRepository fileRepository,
            ...
            CourtUserRepository courtUserRepository) {
        ...
        this.courtUserRepository = courtUserRepository;
    ...
    public void saveCourtUserProfile(CourtUserProfile profile) {
        courtUserRepository.save(profile);
    }

    public CourtUserProfile getCourtUserProfile(String userId) {
        return courtUserRepository.findByUserId(userId);
    }
    ...
    public List<User> searchUsersByRole(String courtRole) {
        UserSearchCriteria criteria = UserSearchCriteria.builder()
                .roleCodes(Collections.singletonList(courtRole))
                .build();
